...
(function (root, factory) {
  ...
  const ADVICE = {
    ...
    // claims ledger (src/claims.mjs): said vs did
  ...
  const CONTENT_DETAIL = new Set(['failed-tool', 'api-error', 'hook-error', 'duplicate-subagent-read', 'unverified-claim', 'contradicted-claim', 'stale-claim']);
